// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WglContext.cs" company="WildGums">
...
namespace Orc.Skia
{
    ...
    {
        #region Constants
        private static readonly ushort gWC;

        private static IntPtr fWindow;
        private static IntPtr fDeviceContext;

        private static readonly WNDCLASS wc;
        #endregion

        #region Fields
        private readonly IntPtr fPbuffer;
        private readonly IntPtr fPbufferDC;
        private readonly IntPtr fPbufferGlContext;
        #endregion
        ...
        public WglContext()
        {
            var iAttrs = new int[]
            {
                Wgl.WGL_ACCELERATION_ARB, Wgl.WGL_FULL_ACCELERATION_ARB, Wgl.WGL_DRAW_TO_WINDOW_ARB, Wgl.TRUE,
                //Wgl.WGL_DOUBLE_BUFFER_ARB, (doubleBuffered ? TRUE : FALSE),
                Wgl.WGL_SUPPORT_OPENGL_ARB, Wgl.TRUE, Wgl.WGL_RED_BITS_ARB, 8, Wgl.WGL_GREEN_BITS_ARB, 8, Wgl.WGL_BLUE_BITS_ARB, 8, Wgl.WGL_ALPHA_BITS_ARB, 8, Wgl.WGL_STENCIL_BITS_ARB, 8, Wgl.NONE, Wgl.NONE
            };
        ...
        public override GRGlTextureInfo CreateTexture(SKSizeI textureSize)
        {
            ...
            return new GRGlTextureInfo {Id = textureId, Target = Wgl.GL_TEXTURE_2D, Format = Wgl.GL_RGBA8};
        }
